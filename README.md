...
3. 获取产物运行结束后，根目录下会生成 LLM_READY_CONTEXT.md。你可以直接将其内容粘贴给 AI，或者作为 RAG（检索增强生成）系统的本地知识库输入。
📈 性能表现项目规模文件数量处理耗时Token 计数准确率小型 (10-50 文件)~30< 0.5s100%中型 (50-200 文件)~150< 1.2s100%大型 (500+ 文件)~600~3.5s100%
